...
import com.github.hatoyuze.protocol.api.DeepseekApi
import com.github.hatoyuze.protocol.api.entity.ThinkingMode
import com.github.hatoyuze.protocol.api.entity.ToolChoice
import com.github.hatoyuze.protocol.api.collectResponse
import com.github.hatoyuze.protocol.api.deepseek
import com.github.hatoyuze.protocol.api.onContent
import com.github.hatoyuze.protocol.api.onThinking
import com.github.hatoyuze.protocol.api.onToolCall
import com.github.hatoyuze.protocol.api.statelessDeepseek
...
fun main() = runBlocking {
    ...
    while (true) {
        ...
        if (input == "/tools") {
            ds.toolHost = com.github.hatoyuze.tool.dsl.toolHost {
                tool("get_weather") {
                    description = "获取指定城市的天气"
                    parameters {
