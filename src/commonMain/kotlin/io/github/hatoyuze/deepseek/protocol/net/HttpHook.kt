...
public interface HttpHook {
    public fun onRequest(method: String, url: String, headers: Map<String, String>, body: String?)

    public fun onResponse(method: String, url: String, status: Int, headers: Map<String, String>, body: String?)
     ...
     * 不追踪 SSE 的钩子无需实现此方法。
     */
    public fun onSseEvent(data: String) {}

    public companion object {
        public val NONE: HttpHook = object : HttpHook {
