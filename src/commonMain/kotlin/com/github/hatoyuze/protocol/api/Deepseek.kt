...
class ChatConfig {
     ...
     * 思考模式。
     *
     * - `null` 或 [com.github.hatoyuze.protocol.api.entity.ThinkingMode.Enabled] — 默认开启思考
     * - [com.github.hatoyuze.protocol.api.entity.ThinkingMode.Disabled] — 关闭思考，不发送 reasoning_content
     * - [com.github.hatoyuze.protocol.api.entity.ThinkingMode.WithEffort] — 指定推理强度
     */
     ...
     *
     * - `null` — 默认 text
     * - [com.github.hatoyuze.protocol.api.entity.ResponseFormat.JSON_OBJECT] — 强制模型输出合法 JSON
     */
     ...
     * 工具调用策略。
     *
     * - `null` — API 默认行为（无 tool 时为 [com.github.hatoyuze.protocol.api.entity.ToolChoice.None]，有 tool 时为 [com.github.hatoyuze.protocol.api.entity.ToolChoice.Auto]）
     * - [com.github.hatoyuze.protocol.api.entity.ToolChoice.None] — 不调用任何工具
     * - [com.github.hatoyuze.protocol.api.entity.ToolChoice.Auto] — 模型自行决定
     * - [com.github.hatoyuze.protocol.api.entity.ToolChoice.Required] — 必须调用工具
     * - [com.github.hatoyuze.protocol.api.entity.ToolChoice.Named] — 强制调用指定工具
     */
...
public open class Deepseek(
     ...
     *
     * 可通过 [com.github.hatoyuze.tool.dsl.toolHost] DSL 构建：
     *
     * ```kotlin
